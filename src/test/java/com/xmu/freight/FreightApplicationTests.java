...
class FreightApplicationTests {
    ...
    @Test
    void contextLoads() {
        List<DefaultFreightDto> a= freightService.getDefaultFreightsAll();
        ...
        System.out.println("删除了"+freightService.deleteDefaultFreight(1));
        t1.setBeDeleted(false);
        System.out.println("回来了"+freightService.updateDefaultFreight(t1));


        List<SpecialFreightDto> s=freightService.getSpecialFreightsAll();
...
//        System.out.println("添加了"+add1);
        ...
        List<DefaultPieceFreightDto> d=freightService.getDefaultPieceFreightAll();
    ...
    void testha(){
        ...
        g1.setWeight(new BigDecimal(4.0));
    ...
    void t1()
    {
        DefaultFreightDto d = freightServiceImpl.findDefaultFreightById(1);
        System.out.println(d.getDestinationList());
